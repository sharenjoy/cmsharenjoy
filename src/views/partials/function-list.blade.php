<ul>
    ...
    @if(isset($functionRules['delete']) AND $functionRules['delete'] == true)
        <li>
            <a class="tooltip-primary" data-toggle="tooltip" data-placement="top" title="{{trans('cmsharenjoy::buttons.delete')}}" data-original-title="{{trans('cmsharenjoy::buttons.delete')}}" onclick="common_modal({type:'delete', id:'{{$item->id}}'});">
    ...
    @if(isset($functionRules['sendmessage']) AND $functionRules['sendmessage'] == true)
        <li>
            <a href="{{$objectUrl.'/sendmessage/'.$item->id}}" class="tooltip-primary" data-toggle="tooltip" data-placement="top" title="{{trans('cmsharenjoy::buttons.sendmessage')}}" data-original-title="{{trans('cmsharenjoy::buttons.sendmessage')}}">
